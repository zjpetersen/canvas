    ...
    let result = 
      <div className="row">
        ...
        <div className="column middle">
          ...
          <p>EtherCanvas is a Dapp running on the Ethereum Polygon blockchain.  
          ...
          <p>Like other NFTs, you can buy and sell your NFT (the tile) whenever you want.  
            Trading can be done through any NFT marketplace, although <a href="https://opensea.io/collection/ether-canvas">OpenSea</a> is where they will be initially listed. 
          ...
          <h2>How can I purchase a tile?</h2>
            <p>In order to purchase an NFT on Polygon you must first bridge your Ethereum.  Below are the high level steps.  
              OpenSea also has a <a href="https://support.opensea.io/hc/en-us/articles/1500012881642-How-do-I-transfer-ETH-from-Ethereum-to-Polygon-">detailed tutorial</a>.</p>
            <ol>
              ...
              <li><a href="https://support.opensea.io/hc/en-us/articles/1500012881642-How-do-I-transfer-ETH-from-Ethereum-to-Polygon-">Bridge your Ethereum to Polygon</a></li>
              <li>Navigate to the <a href="https://opensea.io/collection/ether-canvas">OpenSea collection</a> and pick a tile you're interested in.</li>
          ...
          <h2>Other technical details</h2>
            <ul>
              ...
              <li>One might wonder what the gas fees are like for updating artwork.  To avoid excessive gas fees, the contract is deployed on the <a href="https://polygon.technology/">Polygon</a> sidechain.  This makes fees much, much lower.  Another way fees are reduced is by having the art data emitted as an event.  Both of these make it much cheaper, while still being fully decentralized and traceable.  </li>
            </ul>
    ...
    return (
      <div>
        ...
        <div className="row footer">
          ...
          <div className="column middle">
            Polygon: 0xbd21CF77E72b2f1cbC60F40dD36ed843Fb793dd2
            <br></br>
            <br></br>
